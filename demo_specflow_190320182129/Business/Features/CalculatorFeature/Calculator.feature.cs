...
namespace DemoSpecFlow.Business.Features.CalculatorFeature
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Calculator", Description="\tIn order to avoid silly mistakes\r\n\tAs a math idiot\r\n\tI want to be told the sum o" +
        "f two numbers", SourceFile="Business\\Features\\CalculatorFeature\\Calculator.feature", SourceLine=0)]
